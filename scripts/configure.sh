...
export BOOST_ROOT=${BOOST_ROOT:-"/usr/lib/boost_1_70_0"}
...
#cmake -H"${KRATOS_SOURCE}" -B"${KRATOS_BUILD}/${KRATOS_BUILD_TYPE}" -DINSTALL_PYTHON_USING_LINKS=ON
#cmake -H"${KRATOS_SOURCE}" -B"${KRATOS_BUILD}/${KRATOS_BUILD_TYPE}" -DKRATOS_BUILD_TESTING=ON
